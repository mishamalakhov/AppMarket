...
import android.malakhov.appmarket.Fragments.PhotoPagerFragment;
        ...
        public InfoHolder(View itemView, int type) {
            ...
            if (type == 1) {
                ...
                corzina.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ProductRepository.get().addToCorzina(mProduct);
            ...
            if (position > 1) {
                ...
                switch (position) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        if (mProduct.getMainCamera() == -1) chk.setText("Нет");
                        else chk.setText(mProduct.getMainCamera() + " px");
                        break;
                    case 10:
                        if (mProduct.getFrontCamera() == -1) chk.setText("Нет");
                        else chk.setText(mProduct.getFrontCamera() + " px");
                        break;
                    case 11:
                        chk.setText(String.valueOf(mProduct.getYear()));
                        break;
                    case 12:
